...
describe('auth.middleware', () => {
  ...
  describe('adminGuard', () => {
    ...
    it('should redirect to /shop/products when user is authenticated but not admin', async () => {
      mockAuthStore.isAuthenticated = true
      mockAuthStore.isAdmin = false
      mockAuthStore.user = mockUser
      mockAuthStore.session = mockSession
  ...
  describe('guestGuard', () => {
    ...
    it('should redirect to /shop/products when user is authenticated', async () => {
      mockAuthStore.isAuthenticated = true
      mockAuthStore.user = mockUser
      mockAuthStore.session = mockSession
