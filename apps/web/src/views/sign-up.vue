  ...
  <div class="min-h-screen bg-black flex items-center justify-center px-4 py-8">
    <div class="w-full max-w-lg">
      ...
      <form @submit.prevent="handleEmailSignUp" class="space-y-4">
                <div>
          <label for="fullName" class="block text-white text-sm font-medium mb-2">
            {{ t('auth.yourName') }}
          </label>
          <div class="relative">
            ...
            <input
              ...
              required
              minlength="3"
              class="w-full pl-10 pr-4 py-3 bg-zinc-900 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
            />
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input
              ...
              required
              minlength="6"
              :placeholder="t('auth.enterPasswordChars', {chars: 6})"
        ...
        >
          <span>{{ loading ? t('auth.signInAccount') : t('auth.signUp') }}</span>
          <svg
            v-if="!loading"
            class="w-5 h-5"
            fill="none"
