    ...
    <header class="sticky top-0 z-50 bg-white border-b border-gray-200 transition-shadow"
      ...
      <div class="flex items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center gap-3">
          <div
            class="sm:w-12 sm:h-12 w-6 h-6 bg-gradient-to-br from-purple-500 to-pink-500 sm:rounded-xl rounded-md flex items-center justify-center">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="relative text-black">
            <svg class="w-7 h-7 text-white" fill="none" stroke="black" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
        ...
        <section>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6">
            ...
            <div v-for="item in menuItems" :key="item.id" :class="[
              ...
              item.width === 2
                ? 'sm:col-span-2 xl:col-span-2 2xl:col-span-2'
                : ''
            ]">
              <!-- Imagen/Video -->
              <div :class="[
                'relative bg-gray-200 shrink-0', // ← shrink-0 para mantener altura fija
                item.width === 2 ? 'h-64 xl:h-80' : 'h-48'
              ]">
              ...
              <!-- Contenido del card con flex -->
              <div class="p-4 flex flex-col flex-1"> <!-- ← flex-1 para ocupar espacio restante -->

                <!-- Título y categoría -->
                <div class="mb-3"> <!-- ← Cambiar mb-2 a mb-3 para más espacio -->
                ...
                <!-- Precio y botones - empujados al final con mt-auto -->
